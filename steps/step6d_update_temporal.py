...
try:
    from temporal_update_utils import (
...
class Step6dUpdateTemporal(ttk.Frame):
    ...
    def check_dependencies(self):
        ...
        try:
            import temporal_update_utils
        except ImportError:
            missing_deps.append("temporal_update_utils")
        ...
        if missing_deps:
            ...
            if "temporal_update_utils" in missing_deps:
                self.log("Please ensure temporal_update_utils.py is in the same directory")
    ...
    def _update_thread(self, params, chunk_size, overlap, component_source):
        ...
        try:
            ...
            try:
                import temporal_update_utils as tuf
                import cvxpy as cvx
                from dask.distributed import Client, LocalCluster
                import xarray as xr
            ...
            if cache_path:
                ...
                try:
                    # Import saving_utilities for save_files function
                    try:

        ...
        try:
            ...
            if max_val == 0:
                ...
                return {
                    ...
                    'dilated_mask': np.zeros((min_size, min_size), dtype=bool)
                }
            ...
            return {
                ...
                'dilated_mask': dilated_mask[y_min:y_max, x_min:x_max]
            }
            ...
            if export_format == 'json':
                ...
                for indices, bounds in self.cluster_data:
                    ...
                    boundary_info = {
                        ...
                        'mask_shape': bounds['dilated_mask'].shape
                    }

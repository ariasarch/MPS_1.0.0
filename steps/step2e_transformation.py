    ...
    def _transform_thread(self, step2e_fill_value, create_frame_chunks, create_spatial_chunks):
        ...
        try:
            ...
            try:
                ...
                has_save_func = False
                self.log("Warning: saving_utilities.save_files not found, using placeholder")
            ...
            try:
                ...
                self.log("Warning: saving_utilities.save_hw_chunks_direct not found, using placeholder")
            ...
            if create_frame_chunks:
                ...
                try:
                    ...
                    from saving_utilities import get_optimal_chk

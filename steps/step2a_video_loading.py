        ...
        try:
            ...
            if detect_line_splitting:
                ...
                try:
                    ...
                    line_splitting_frames = detect_line_splitting_frames(step2a_varr)
